...
Only requiring some minor changes is argo.cpp.
...
Changes to argo.cpp
----------------------
argo.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
