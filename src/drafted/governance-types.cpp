...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "ArgoNetwork") type = ArgoNetwork;
    if(strType == "ArgoNetworkVariable") type = ArgoNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == ArgoNetwork) s = "ArgoNetwork";
    if(type == ArgoNetworkVariable) s = "ArgoNetworkVariable";
