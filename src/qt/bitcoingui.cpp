    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Argo Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Argo address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and argo: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Argo Core"), this);
    aboutAction->setStatusTip(tr("Show information about Argo Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Argo Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Argo addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Argo addresses"));
    ...
    openAction->setStatusTip(tr("Open a argo: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Argo Core help message to get a list with possible Argo Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Argo Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Argo network", "", count));
    } else {
...
{
    QString strTitle = tr("Argo Core"); // default title
