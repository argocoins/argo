    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Argo Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Argo Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  argo-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Argo in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 ARGO, 0.1 ARGO, 1 ARGO and 10 ARGO -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://argopay.atlassian.net/wiki/display/DOC/PrivateSend\">https://argopay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Argo Core is shutting down...") + "<br /><br />" +
