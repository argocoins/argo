...
This mechanism has been integrated into Bitcore-Node-Argo which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/argopay/insight-api-argo#web-socket-api](https://github.com/argopay/insight-api-argo#web-socket-api)
* API: [https://github.com/argopay/insight-api-argo#instantsend-transactions](https://github.com/argopay/insight-api-argo#instantsend-transactions)
...
By default, the Argo Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Argo Core daemon:
