...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Argo related functionality
...
/*
    ...
    allow endless transaction that would bloat Argo and make it unusable. To
